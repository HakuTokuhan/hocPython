...
HEALTH_FONT = pygame.font.SysFont('times', 20)  # define font and size
...
def draw_window(player_superman, player_batman, batman_bullets, superman_bullets, batman_health, superman_health):
    ...
    superman_health_text = HEALTH_FONT.render("Health:" + str(superman_health), 1, BLUE)
    WIN.blit(superman_health_text, (WIDTH - 80, HEIGHT - 20))
...
def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == SUPERMAN_HIT:  # check when superman get hit
                superman_health -= 1
                print(superman_health)
        ...
        draw_window(player_superman, player_batman, batman_bullets, superman_bullets, batman_health, superman_health)
