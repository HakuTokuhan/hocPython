...
MAX_BULLETS = 2  # number of bullet that a character can shoot at a time
...
def draw_window(player_superman, player_batman, batman_bullets):
...
def handle_bullets(batman_bullets, player_batman):
    ""
    for bullet in batman_bullets:
...
def main():
    ...
    while run:
        ...
        handle_bullets(batman_bullets, player_batman)
        draw_window(player_superman, player_batman, batman_bullets)
